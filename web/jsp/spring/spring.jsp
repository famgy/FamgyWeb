...
<body>
<canvas id="myCanvas">你的浏览器不支持HTML5画布技术，请使用谷歌浏览器。</canvas>

<script type="text/javascript" src="../../js/spring/ge1doot.js"></script>
<script type="text/javascript">
    function test1() {
        /* ==== definitions ==== */
        var diapo = [], layers = [];
        var scr, pointer, ctx, camera, light, fps = 0, quality = [1,2];
